...
public class Colorful{
	...
	public static void play() {
		...
		playb.setIcon(new ImageIcon(Colorful.class.getResource("/application/Icons/Colorful/play.png")));

		JButton stop = new JButton("");
		stop.setIcon(new ImageIcon(Colorful.class.getResource("/application/Icons/Colorful/stop.png")));
		...
		panel.add(open);
		open.setIcon(new ImageIcon(Colorful.class.getResource("/application/Icons/Colorful/open.png")));
		...
		Prev.setIcon(new ImageIcon(Colorful.class.getResource("/application/Icons/Colorful/prev.png")));
		...
		repeat.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(repeatT == true){
					repeat.setIcon(new javax.swing.ImageIcon(getClass().getResource("/application/Icons/Colorful/repeat-once.png")));
					mlp.setMode(MediaListPlayerMode.REPEAT);
					repeatT = false;
					repeat.setToolTipText("Repeat All");
				}
				else{
					repeat.setIcon(new javax.swing.ImageIcon(getClass().getResource("/application/Icons/Colorful/repeat.png")));
		...
		repeat.setIcon(new ImageIcon(Colorful.class.getResource("/application/Icons/Colorful/repeat.png")));
		repeat.setToolTipText("Repeat Single");
		...
		next.setIcon(new ImageIcon(Colorful.class.getResource("/application/Icons/Colorful/next.png")));
		...
		add.setIcon(new ImageIcon(Colorful.class.getResource("/application/Icons/Colorful/add.png")));
            ...
            public void valueChanged(ListSelectionEvent e) {
                if (!e.getValueIsAdjusting()) {
                    ...
                    if(emp.isPlaying()==false){
                    	playb.setIcon(new javax.swing.ImageIcon(getClass().getResource("/application/Icons/Colorful/pause.png")));
                    }
                }
            }
        });
		
		playlist.setIcon(new ImageIcon(Colorful.class.getResource("/application/Icons/Colorful/playlist.png")));
		panel.add(playlist);
		...
		fullscreenb.setIcon(new ImageIcon(Colorful.class.getResource("/application/Icons/Colorful/fullscreenplayer.png")));
		...
		audioToggle.setIcon(new ImageIcon(Colorful.class.getResource("/application/Icons/Colorful/audioToggle.png")));
		...
		subtitles.setIcon(new ImageIcon(Colorful.class.getResource("/application/Icons/Colorful/subtitles.png")));
		...
		snapshot.setIcon(new ImageIcon(Colorful.class.getResource("/application/Icons/Colorful/snapshot.png")));
		...
		theme.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				final String[] theme = { "Colorful", "Graphite", "Metal"};
		...
		theme.setIcon(new ImageIcon(Colorful.class.getResource("/application/Icons/Colorful/theme.png")));
		...
		Volume.setIcon(new ImageIcon(Colorful.class.getResource("/application/Icons/Colorful/mvol.png")));
		...
		Volume.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				if (isPlaying) {
					Volume.setIcon(new javax.swing.ImageIcon(getClass().getResource("/application/Icons/Colorful/mute.png")));
					isPlaying = false;
					emp.mute();
				} else {
					...
					if(volumeSlider.getValue()>10 && volumeSlider.getValue()<30)
						Volume.setIcon(new javax.swing.ImageIcon(getClass().getResource("/application/Icons/Colorful/lvol.png")));
					else if(volumeSlider.getValue()>30 && volumeSlider.getValue()<60)
						Volume.setIcon(new javax.swing.ImageIcon(getClass().getResource("/application/Icons/Colorful/mvol.png")));
					else if(volumeSlider.getValue()<=100 && volumeSlider.getValue()>=60)
						Volume.setIcon(new javax.swing.ImageIcon(getClass().getResource("/application/Icons/Colorful/hvol.png")));
					isPlaying = true;
					emp.mute();
				}
			}
		...
		playb.addActionListener( new ActionListener()
		{
			...
			public void actionPerformed(java.awt.event.ActionEvent arg0) {
				...
				if (isPlaying) {
					playb.setIcon(new javax.swing.ImageIcon(getClass().getResource("/application/Icons/Colorful/play.png")));
					isPlaying = false;
					emp.pause();
				} else {
					playb.setIcon(new javax.swing.ImageIcon(getClass().getResource("/application/Icons/Colorful/pause.png")));
