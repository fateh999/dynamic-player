...
public class Metal{
	...
	public static void play() {
		...
		playlistPanel.setBackground(new Color(46, 47, 48));
		p.add(playlistPanel, BorderLayout.WEST);
		playlistPanel.setLayout(new BorderLayout());
		playlistPanel.setVisible(false);

		JPanel panel = new JPanel();
		panel.setBackground(new Color(128, 130, 135));
		...
		playb.setIcon(new ImageIcon(Metal.class.getResource("/application/Icons/Metal/play.png")));

		JButton stop = new JButton("");
		stop.setIcon(new ImageIcon(Metal.class.getResource("/application/Icons/Metal/stop.png")));
		...
		panel.add(open);
		open.setIcon(new ImageIcon(Metal.class.getResource("/application/Icons/Metal/open.png")));
		...
		playlistView.setForeground(Color.white);
		playlistView.setBackground(new Color(46, 47, 48));
		...
		toolbar.setBackground(new Color(128, 130, 135));
		...
		Prev.setIcon(new ImageIcon(Metal.class.getResource("/application/Icons/Metal/prev.png")));
		...
		repeat.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(repeatT == true){
					repeat.setIcon(new javax.swing.ImageIcon(getClass().getResource("/application/Icons/Metal/repeat-once.png")));
					mlp.setMode(MediaListPlayerMode.REPEAT);
					repeatT = false;
					repeat.setToolTipText("Repeat All");
				}
				else{
					repeat.setIcon(new javax.swing.ImageIcon(getClass().getResource("/application/Icons/Metal/repeat.png")));
		...
		repeat.setIcon(new ImageIcon(Metal.class.getResource("/application/Icons/Metal/repeat.png")));
		repeat.setToolTipText("Repeat Single");
		...
		next.setIcon(new ImageIcon(Metal.class.getResource("/application/Icons/Metal/next.png")));
		...
		add.setIcon(new ImageIcon(Metal.class.getResource("/application/Icons/Metal/add.png")));
            ...
            public void valueChanged(ListSelectionEvent e) {
                if (!e.getValueIsAdjusting()) {
                    ...
                    if(emp.isPlaying()==false){
                    	playb.setIcon(new javax.swing.ImageIcon(getClass().getResource("/application/Icons/Metal/pause.png")));
                    }
                }
            }
        });
		
		playlist.setIcon(new ImageIcon(Metal.class.getResource("/application/Icons/Metal/playlist.png")));
		panel.add(playlist);
		...
		fullscreenb.setIcon(new ImageIcon(Metal.class.getResource("/application/Icons/Metal/fullscreenplayer.png")));
		
		positionSlider = new JSlider();
		positionSlider.setMaximum(1000);
		positionSlider.setValue(0);
		positionSlider.setForeground(Color.black);
		...
		audioToggle.setIcon(new ImageIcon(Metal.class.getResource("/application/Icons/Metal/audioToggle.png")));
		...
		subtitles.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				fileChooser.setAcceptAllFileFilterUsed(false);
				FileNameExtensionFilter filter = new FileNameExtensionFilter("Subtitle Files", new String[] {"cdg","idx","srt","sub","utf","ass","ssa","aqt","jss","psb","rt","smi","txt","smil","stl","usf","dks","pjs","mpl2","mks","vtt"});
				fileChooser.setFileFilter(filter);
				fileChooser.addChoosableFileFilter(filter);
				fileChooser.setCurrentDirectory(new File(System.getProperty("user.home")));
				int result = fileChooser.showOpenDialog(null);
		...
		subtitles.setIcon(new ImageIcon(Metal.class.getResource("/application/Icons/Metal/subtitles.png")));
		...
		snapshot.setIcon(new ImageIcon(Metal.class.getResource("/application/Icons/Metal/snapshot.png")));
		...
		theme.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				final String[] theme = { "Metal", "Graphite", "Colorful"};
		...
		theme.setIcon(new ImageIcon(Metal.class.getResource("/application/Icons/Metal/theme.png")));
		...
		label.setForeground(new Color(142, 144, 150));
		panel.add(label);

		JLabel Volume = new JLabel("");
		Volume.setIcon(new ImageIcon(Metal.class.getResource("/application/Icons/Metal/mvol.png")));
		Volume.setForeground(new Color(142, 144, 150));
		...
		Volume.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				if (isPlaying) {
					Volume.setIcon(new javax.swing.ImageIcon(getClass().getResource("/application/Icons/Metal/mute.png")));
					isPlaying = false;
					emp.mute();
				} else {
					...
					if(volumeSlider.getValue()>10 && volumeSlider.getValue()<30)
						Volume.setIcon(new javax.swing.ImageIcon(getClass().getResource("/application/Icons/Metal/lvol.png")));
					else if(volumeSlider.getValue()>30 && volumeSlider.getValue()<60)
						Volume.setIcon(new javax.swing.ImageIcon(getClass().getResource("/application/Icons/Metal/mvol.png")));
					else if(volumeSlider.getValue()<=100 && volumeSlider.getValue()>=60)
						Volume.setIcon(new javax.swing.ImageIcon(getClass().getResource("/application/Icons/Metal/hvol.png")));
					isPlaying = true;
					emp.mute();
				}
			}
		...
		playb.addActionListener( new ActionListener()
		{
			...
			public void actionPerformed(java.awt.event.ActionEvent arg0) {
				...
				if (isPlaying) {
					playb.setIcon(new javax.swing.ImageIcon(getClass().getResource("/application/Icons/Metal/play.png")));
					isPlaying = false;
					emp.pause();
				} else {
					playb.setIcon(new javax.swing.ImageIcon(getClass().getResource("/application/Icons/Metal/pause.png")));
